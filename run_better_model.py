...
class BertClassification(nn.Module):
    def __init__(self, num_classes, bert, dropout=0.0):
        super().__init__()
        self.bert = bert
...
# using model ckiplab/bert-base-chinese-ner
bert_path = '/home/u200111323/models/bert-base-chinese-ner'
...
def net_getter():
    ...
    net = BertClassification(len(label_vocab), bert, dropout)
    net = net.to(device)
    return net
